...
export const usePartnershipContentsStore = create<PartnershipContentsState>(
	() => ({
		...
		partnershipList: [
			{
				heading: '리테일 셀러',
				body: 'TEAM 5010이 제공하는 서비스를 자유롭게 홍보, 활용하여 더 많은 잠재고객들에게 판매하는 리테일 셀러가 되어보세요. 판매금의 일부를 커미션으로 정산받으실 수 있어요.',
			},
			{
				heading: '기업간 거래 및 업무 협약',
				body: 'TEAM 5010이 제공하는 서비스에 관심있거나 레버리지하고자 하는 기업들에게, 비즈니스 규모나 업종에 관계없이 다양한 B2B 옵션들과 업무 협약 등을 제공하고 있어요.',
			},
		],
		contact: {
			heading: 'Contact Us',
