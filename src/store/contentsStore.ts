...
export const useContentsStore = create<ContentsState>((set) => ({
	...
	review: {
		items: [
			...
			{
				name: '김동희',
				body: "저는 약 5년 간 국내 대기업 증권사 PB 및 투자관련 회사에서 근무한 경험이 있습니다. (...) 책을 읽어 내려갈 때마다, 와디즈 펀딩에서 봤었던 '이건 되는 방법이다' 라는 후기에 백번 공감이 되었습니다. (...) 'Simple is the Best' 지금까지 더 좋은 보조지표를 찾기 위해, 그리고 더 높은 확률을 찾기 위해 노력했던 것들이 비워지면서 오히려 제 정신을 더 맑게 만들었습니다.",
				platform: 'WADIZ',
			},
		],
	},
